...
# ENVIRONMENTS=("compute", "production" "acc")
# # 色の定義
# GREEN='\033[0;32m'
# NC='\033[0m' 
...
#             rm -rf "${env}/.terraform/"
#             if [ $? -eq 0 ]; then
#                 echo -e "${GREEN}✔${NC} Successfully removed .terraform directory in ${PROJECT_DIR}/${env}"
#             fi
#         else
#             echo "No .terraform directory found in ${PROJECT_DIR}/${env}"
#         fi
#     done
#     popd > /dev/null
# done
